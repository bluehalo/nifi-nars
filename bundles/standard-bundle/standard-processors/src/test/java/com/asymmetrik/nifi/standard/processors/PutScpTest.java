...
import static com.asymmetrik.nifi.standard.processors.PutScp.HOSTNAME;
import static com.asymmetrik.nifi.standard.processors.PutScp.PERMISSIONS;
import static com.asymmetrik.nifi.standard.processors.PutScp.PRIVATE_KEY_PATH;
import static com.asymmetrik.nifi.standard.processors.PutScp.REJECT_ZERO_BYTE;
import static com.asymmetrik.nifi.standard.processors.PutScp.REL_FAILURE;
import static com.asymmetrik.nifi.standard.processors.PutScp.REL_REJECT;
import static com.asymmetrik.nifi.standard.processors.PutScp.REL_SUCCESS;
import static com.asymmetrik.nifi.standard.processors.PutScp.REMOTE_PATH;
import static com.asymmetrik.nifi.standard.processors.PutScp.USERNAME;
import static com.asymmetrik.nifi.standard.processors.PutScp.USE_COMPRESSION;
...
public class PutScpTest {
    ...
    public void setUp() throws Exception {
        ...
        runner.setProperty(PRIVATE_KEY_PATH, KEY);
        runner.setProperty(REMOTE_PATH, TMP_DIR.getAbsolutePath());
    ...
    public void testUnauthenticated() {
        runner.removeProperty(PRIVATE_KEY_PATH);
    ...
    public void testAllowZeroLengthFile() {
        runner.setProperty(REJECT_ZERO_BYTE, "false");
    ...
    public void testUseCompression() {
        runner.setProperty(USE_COMPRESSION, "true");
        runner.enqueue(input, ATTRIBUTES);
    ...
    public void testPermissions() {
        runner.setProperty(PERMISSIONS, "0700");
        runner.enqueue(input, ATTRIBUTES);
